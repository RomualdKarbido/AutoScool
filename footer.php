  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-7">
        ...
        <p>Автошкола является структурным подразделением ГБОУ СПОУ ПТ №2. Теоретические занятия проводятся в оборудованных компьютерных классах, находящихся в здании техникума. Практическое вождение проводится на открытой площадке, оборудованной в соответствии с нормами и требованиями ГИБД.</p>
      </div>
...
$(document).ready(function(){
	$(".colorbox").colorbox({rel:'.img-responsive'});
});
</script>
