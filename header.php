...
<link rel="stylesheet/less" type="text/css" href="/wp-content/themes/r1/css/less.css"> 
...
<nav class="navbar navbar-default navbar-fixed-top">  
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="myDefaultNavbar1">
      <ul class="nav navbar-nav">
        ...
        <li class="hidden-xs"><a href="/" ><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
 ...
 <li  ><a href="/poisk/" ><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></li>
 </ul>
     
<form class="navbar-form navbar-right form-inline hidden-sm " role="search" method="get" id="searchform" action="<?php echo home_url( '/' ) ?>">      
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      ...
      <td style="width:50px; padding-left:10px;"><button type="submit" id="searchsubmit" value="найти" class="btn btn-default">Искать</button></td>
    </tr>
  </tbody>
</table>
 </form>
